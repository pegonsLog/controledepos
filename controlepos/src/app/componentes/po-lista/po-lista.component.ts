...
const MOCK_POS_DATA: Po[] = [
  ...
  { numero_do_po: 'PO-010', data_po: '2024-06-01', analista: 'Camila Santos', situacao: 'Concluído', solicitante: 'Empresa G', bairro: 'Santana', tipo_de_logradouro: 'Avenida', logradouro: 'Norte', complemento: 'Bloco A, Apto 1001', detalhamento: 'Detalhamento do PO-010: Entrega finalizada e aprovada.', data_implantacao: '2024-06-07', funcionario_responsavel: 'Diego R.', observacoes: 'Entrega finalizada', especificacoes: 'Customizado', e_mail: 'camila.s@empresa.com', tipo_de_solicitante: 'Interno', data_enc_dro: '2024-07-10', link_do_po: 'http://link.com/po010', numero_de_controle: 'CTRL010', data_arquivamento: '2024-07-15', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-011', data_po: '2024-06-10', analista: 'Bruno Oliveira', situacao: 'Em Andamento', solicitante: 'Cliente Z', bairro: 'Perdizes', tipo_de_logradouro: 'Rua', logradouro: 'Residencial', complemento: 'Casa 5, Fundos', detalhamento: 'PO-011: Ajustes solicitados pelo cliente em andamento.', data_implantacao: '2024-06-15', funcionario_responsavel: 'Vanessa P.', observacoes: 'Ajustes solicitados', especificacoes: 'Básico', e_mail: 'bruno.o@cliente.com', tipo_de_solicitante: 'Cliente', data_enc_dro: '2024-07-20', link_do_po: 'http://link.com/po011', numero_de_controle: 'CTRL011', data_arquivamento: '2024-07-25', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-012', data_po: '2024-07-03', analista: 'Juliana Pereira', situacao: 'Pendente', solicitante: 'Empresa H', bairro: 'Tatuapé', tipo_de_logradouro: 'Praça', logradouro: 'Central', complemento: 'Quiosque 2', detalhamento: 'Detalhamento do PO-012: Falta definir escopo completo.', data_implantacao: '2024-07-09', funcionario_responsavel: 'Gustavo L.', observacoes: 'Falta definir escopo', especificacoes: 'Premium', e_mail: 'juliana.p@empresa.com', tipo_de_solicitante: 'Parceiro', data_enc_dro: '2024-08-18', link_do_po: 'http://link.com/po012', numero_de_controle: 'CTRL012', data_arquivamento: '2024-08-22', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-013', data_po: '2024-07-12', analista: 'Rodrigo Martins', situacao: 'Em Andamento', solicitante: 'Cliente W', bairro: 'Vila Madalena', tipo_de_logradouro: 'Rua', logradouro: 'Boêmia', complemento: 'Sobreloja', detalhamento: 'PO-013: Desenvolvimento em progresso conforme cronograma.', data_implantacao: '2024-07-18', funcionario_responsavel: 'Amanda C.', observacoes: '', especificacoes: 'Padrão', e_mail: 'rodrigo.m@cliente.com', tipo_de_solicitante: 'Cliente', data_enc_dro: '2024-08-28', link_do_po: 'http://link.com/po013', numero_de_controle: 'CTRL013', data_arquivamento: '2024-09-02', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-014', data_po: '2024-08-05', analista: 'Beatriz Almeida', situacao: 'Concluído', solicitante: 'Empresa I', bairro: 'Morumbi', tipo_de_logradouro: 'Avenida', logradouro: 'das Mansões', complemento: 'Portaria Principal', detalhamento: 'Detalhamento do PO-014: Cliente satisfeito com a entrega.', data_implantacao: '2024-08-10', funcionario_responsavel: 'Felipe N.', observacoes: 'Cliente satisfeito', especificacoes: 'Customizado', e_mail: 'beatriz.a@empresa.com', tipo_de_solicitante: 'Interno', data_enc_dro: '2024-09-15', link_do_po: 'http://link.com/po014', numero_de_controle: 'CTRL014', data_arquivamento: '2024-09-20', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-015', data_po: '2024-08-15', analista: 'Vinicius Barros', situacao: 'Aguardando Aprovação', solicitante: 'Cliente V', bairro: 'Campo Belo', tipo_de_logradouro: 'Alameda', logradouro: 'Florida', complemento: 'Torre B, Apto 505', detalhamento: 'PO-015: Proposta enviada, aguardando feedback.', data_implantacao: '2024-08-20', funcionario_responsavel: 'Renata G.', observacoes: 'Proposta enviada', especificacoes: 'Básico', e_mail: 'vinicius.b@cliente.com', tipo_de_solicitante: 'Cliente', data_enc_dro: '2024-09-25', link_do_po: 'http://link.com/po015', numero_de_controle: 'CTRL015', data_arquivamento: '2024-09-30', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-016', data_po: '2024-09-02', analista: 'Larissa Ferreira', situacao: 'Em Andamento', solicitante: 'Empresa J', bairro: 'Liberdade', tipo_de_logradouro: 'Rua', logradouro: 'Oriental', complemento: 'Loja 15', detalhamento: 'PO-016: Reunião de alinhamento agendada.', data_implantacao: '2024-09-08', funcionario_responsavel: 'Eduardo K.', observacoes: 'Reunião agendada', especificacoes: 'Premium', e_mail: 'larissa.f@empresa.com', tipo_de_solicitante: 'Parceiro', data_enc_dro: '2024-10-12', link_do_po: 'http://link.com/po016', numero_de_controle: 'CTRL016', data_arquivamento: '2024-10-18', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-017', data_po: '2024-09-11', analista: 'Daniel Rocha', situacao: 'Pendente', solicitante: 'Cliente U', bairro: 'Consolação', tipo_de_logradouro: 'Travessa', logradouro: 'Estreita', complemento: 'Portão 2', detalhamento: 'PO-017: Aguardando informações técnicas do cliente.', data_implantacao: '2024-09-17', funcionario_responsavel: 'Patricia O.', observacoes: 'Aguardando informações técnicas', especificacoes: 'Padrão', e_mail: 'daniel.r@cliente.com', tipo_de_solicitante: 'Cliente', data_enc_dro: '2024-10-20', link_do_po: 'http://link.com/po017', numero_de_controle: 'CTRL017', data_arquivamento: '2024-10-25', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-018', data_po: '2024-10-01', analista: 'Sofia Castro', situacao: 'Concluído', solicitante: 'Empresa K', bairro: 'Aclimação', tipo_de_logradouro: 'Rua', logradouro: 'Tranquila', complemento: 'Casa Amarela', detalhamento: 'Detalhamento do PO-018: Projeto finalizado com sucesso e documentado.', data_implantacao: '2024-10-06', funcionario_responsavel: 'Roberto M.', observacoes: 'Finalizado com sucesso', especificacoes: 'Customizado', e_mail: 'sofia.c@empresa.com', tipo_de_solicitante: 'Interno', data_enc_dro: '2024-11-10', link_do_po: 'http://link.com/po018', numero_de_controle: 'CTRL018', data_arquivamento: '2024-11-15', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-019', data_po: '2024-10-09', analista: 'Thiago Almeida', situacao: 'Em Andamento', solicitante: 'Cliente T', bairro: 'Bela Vista', tipo_de_logradouro: 'Avenida', logradouro: 'Paulista', complemento: 'Andar 12, Sala 1205', detalhamento: 'PO-019: Atualmente em fase de testes intensivos.', data_implantacao: '2024-10-14', funcionario_responsavel: 'Carolina V.', observacoes: 'Fase de testes', especificacoes: 'Básico', e_mail: 'thiago.a@cliente.com', tipo_de_solicitante: 'Cliente', data_enc_dro: '2024-11-20', link_do_po: 'http://link.com/po019', numero_de_controle: 'CTRL019', data_arquivamento: '2024-11-25', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() },
  { numero_do_po: 'PO-020', data_po: '2024-11-03', analista: 'Alice Ribeiro', situacao: 'Pendente', solicitante: 'Empresa L', bairro: 'Cambuci', tipo_de_logradouro: 'Praça', logradouro: 'Histórica', complemento: 'Banca Central', detalhamento: 'Detalhamento do PO-020: Aguardando liberação de verba para início.', data_implantacao: '2024-11-08', funcionario_responsavel: 'Marcelo P.', observacoes: 'Aguardando liberação de verba', especificacoes: 'Premium', e_mail: 'alice.r@empresa.com', tipo_de_solicitante: 'Parceiro', data_enc_dro: '2024-12-12', link_do_po: 'http://link.com/po020', numero_de_controle: 'CTRL020', data_arquivamento: '2024-12-18', criado_em: new Date().toISOString(), ultima_edicao: new Date().toISOString() }
];
