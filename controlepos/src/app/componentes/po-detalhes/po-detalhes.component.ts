...
const MOCK_POS: Po[] = [
  { numero_do_po: 'PO-001', data_po: new Date(2024, 0, 15), analista: 'João Silva', situacao: 'Concluído', solicitante: 'Empresa A', bairro: 'Centro', tipo_de_logradouro: 'Rua', logradouro: 'Principal', complemento: 'Sala 101', detalhamento: 'Detalhes da PO-001: Projeto de desenvolvimento de software.', data_implantacao: new Date(2024, 0, 20), funcionario_responsavel: 'Ana P.', observacoes: 'Entregue com sucesso', especificacoes: 'Completo', e_mail: 'joao@empresa.com', tipo_de_solicitante: 'Cliente', data_enc_dro: new Date(2024, 1, 10), link_do_po: 'http://link.com/po001', numero_de_controle: 'CTRL001', data_arquivamento: new Date(2024, 1, 15), criado_em: new Date(), ultima_edicao: new Date() },
  { numero_do_po: 'PO-002', data_po: new Date(2024, 1, 20), analista: 'Maria Oliveira', situacao: 'Em Andamento', solicitante: 'Empresa B', bairro: 'Vila Nova', tipo_de_logradouro: 'Avenida', logradouro: 'Secundária', complemento: 'Andar 5', detalhamento: 'PO-002: Implementação de sistema de gestão.', data_implantacao: new Date(2024, 1, 25), funcionario_responsavel: 'Carlos R.', observacoes: 'Em desenvolvimento', especificacoes: 'Parcial', e_mail: 'maria@empresa.com', tipo_de_solicitante: 'Interno', data_enc_dro: new Date(2024, 2, 15), link_do_po: 'http://link.com/po002', numero_de_controle: 'CTRL002', data_arquivamento: new Date(2024, 2, 20), criado_em: new Date(), ultima_edicao: new Date() },
  ...
  { numero_do_po: 'PO-010', data_po: new Date(2024, 5, 1), analista: 'Camila Santos', situacao: 'Planejado', solicitante: 'Nova Empresa', bairro: 'Alphaville', tipo_de_logradouro: 'Avenida', logradouro: 'Principal Norte', complemento: 'Torre Beta, cj 1500', detalhamento: 'PO-010: Início do planejamento para novo cliente.', data_implantacao: new Date(2024, 5, 10), funcionario_responsavel: 'Bruno V.', observacoes: 'Fase inicial', especificacoes: 'Completo', e_mail: 'camila.s@novaempresa.com', tipo_de_solicitante: 'Cliente', data_enc_dro: new Date(2024, 6, 5), link_do_po: 'http://link.com/po010', numero_de_controle: 'CTRL010', data_arquivamento: new Date(2024, 6, 10), criado_em: new Date(), ultima_edicao: new Date() }
];
